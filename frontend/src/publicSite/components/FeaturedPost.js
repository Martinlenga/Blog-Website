    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
      ...
      >
        ...
        <div className="w-full lg:w-[58%] p-6 sm:p-8 lg:p-10 flex flex-col justify-between relative bg-white z-20">
          ...
          <div>
            {/* 🚀 THE FIX: Both Category AND Series are now visible side-by-side */}
            <div className="flex items-center flex-wrap gap-3 mb-4">
              <span className="px-2.5 py-1 bg-indigo-600 text-white text-[9px] font-extrabold uppercase tracking-widest rounded shadow-sm shrink-0">
                Cover Story
              </span>
              ...
              {post.series_name && (
                <>
                  ...
                  <span className="flex items-center gap-1.5 px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-100 text-[9px] font-extrabold uppercase tracking-widest rounded shadow-sm">
                    <Layers size={10} /> {post.series_name} {post.part_number && `• PART ${post.part_number}`}
                  </span>
                </>
              )}
            </div>
